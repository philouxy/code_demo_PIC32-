...
#include "Mc32DriverAdc.h"              // add the lib (.h) for the S_ADCResult
 ...
 * Add the "Wait" state => in this state, the program does nothing 
...
/* Application Data
  ...
  Description:
    This structure holds the application's data. In the APP_DATA struct add an 
 * another strcut wich will allow the ADC    
...
typedef struct
{
    ...
    S_ADCResults ADCValues;     //linked at the Mc32DriverAdc headerfile (BSP) 
